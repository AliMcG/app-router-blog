...
import type { BlogPostPostgres, Cloundinary, DataResultSingle, DataRows } from "../../../types";
...
export default function EditPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
          ...
          // eslint-disable-next-line @typescript-eslint/non-nullable-type-assertion-style
          dispatch({ type: ActionKind.Description, payload: data?.description as string })
        }, [])
    ...
    function handleSubmit(e: SyntheticEvent) {
      ...
      mutate(updatedBody)
    //   const res = http<DataRows>(`/api/update-blog`, {
    //     method: "POST",
    //     headers: {
    ...
    function uploadWithCurrentImage() {
      // eslint-disable-next-line @typescript-eslint/non-nullable-type-assertion-style
      const updatedBody = { ...state, id: data?.id as string, image: data?.image as string}
      mutate(updatedBody)
    //   const res = http<DataRows>(`/api/update-blog`, {
    //     method: "POST",
    //     headers: {
